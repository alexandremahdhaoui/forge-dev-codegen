...
{{ end }}
{{- if .HasDatagrams }}
use {{ .AppCrate }}::{{ .Datagram.Cell }}::adapter::{{ .Datagram.Snake }}_udp_client::{{ .Datagram.ClientStruct }};
use {{ .AppCrate }}::{{ .Datagram.Cell }}::driver::{{ .Datagram.Snake }}_udp_driver::{{ .Datagram.DriverStruct }};
use {{ .CoreCrate }}::{{ .Datagram.Cell }}::controller::{{ .Datagram.Snake }}_controller::{{ .Datagram.Pascal }}ControllerError;
...
mockall::mock! {
    ...
    impl {{ .CoreCrate }}::{{ .Datagram.Cell }}::controller::{{ .Datagram.Snake }}_controller::{{ .Datagram.Pascal }}Controller for {{ .Datagram.Pascal }}Controller {
{{- range .Datagram.Ops }}
